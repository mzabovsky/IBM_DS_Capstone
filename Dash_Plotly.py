...
def get_pie_char(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values=values, names=labels, title='Total Success Launches For Site ' + entered_site)
        return fig    
...
def get_scatter_char(entered_site, entered_payload):
